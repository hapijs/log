...
const createShouldIgnoreRequest = function (paths, tags) {
...
const createShouldIgnoreEvent = function (channels, tags) {
...
const doNotIgnoreFunction = function () {

    return false;
};


const validateArrayOfStrings = function (arr, name) {
...
const validateLogLevel = function (level, name) {
...
const setupLogLevelMap = function (logLevelMap) {
